    ...
    <xsl:element name="tr">
      ...
      <th>
        <xsl:element name="a">
          ...
          <img src="images/cart-add.png" alt="Add to Cart" title="Add to Cart" class="fx-add-to"/>
          <img src="images/cart-remove.png" alt="Remove from Cart" title="Remove from Cart" class="fx-remove-from"/>
        </xsl:element>
      </th>
      <td>
