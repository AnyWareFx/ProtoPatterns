...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="product-benefit">
    ...
    <form class="fx-rounded-bottom fx-two-column-form" action="javascript:void(0);">
      ...
      <input type="hidden" name="resource">
        <xsl:attribute name="value">product_benefits/<xsl:value-of select="id"/></xsl:attribute>
      </input>
      <fieldset>
        <legend class="fx-rounded-bottom">
          <img src="images/product.png"/> Benefit
        ...
        <ol>
          ...
          <li>
            ...
            <textarea id="description" name="product_benefit[description]">
  ...
  <xsl:template match="name">
    ...
    <input id="name" name="product_benefit[name]">
